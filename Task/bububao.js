...
############## 圈x
#步步宝获取TOKEN
https:\/\/bububao\.duoshoutuan\.com\/user\/* url script-request-header https://github.com/kinson90/ziye001/tree/main/Task/bububao.js

############## loon
#步步宝获取TOKEN
http-response https:\/\/bububao\.duoshoutuan\.com\/user\/* script-path=https://github.com/kinson90/ziye001/tree/main/Task/bububao.js, requires-body=1,max-size=0, tag=步步宝获取TOKEN

############## surge
#步步宝获取TOKEN
步步宝获取TOKEN = type=http-response,pattern=https:\/\/bububao\.duoshoutuan\.com\/user\/*,script-path=https://github.com/kinson90/ziye001/tree/main/Task/bububao.js
*/
